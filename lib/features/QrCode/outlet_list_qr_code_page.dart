...
class OutletListQrCodePage extends StatefulWidget {
  const OutletListQrCodePage({super.key});

  @override
  State<OutletListQrCodePage> createState() =>
      _OutletListQrCodePageState();
}

class _OutletListQrCodePageState extends State<OutletListQrCodePage> {
